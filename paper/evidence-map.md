...
|---|---|---|
| The bit-equivalent is the minimum behavioral mutual information needed to attain a reward target. | `THEORETICAL` | [`docs/theory.md`](../docs/theory.md) |
...
| Canonical actions are quotiented by finite deployment behavior rather than syntax or unused state. | `IMPLEMENTED` | [`core/behavior.py`](../src/infinite_rulebook/core/behavior.py), regression tests |
...
| Independent coordinates tensorize, giving \(B_\infty(\rho)=\rho\log3\) for finite baseline targets. | `THEORETICAL` | [`docs/theory.md`](../docs/theory.md) |
...
| Five of six v1 effect-adequacy gates passed; the registered relevant-over-total TRIVIA reward gate failed with interval \([0,2/3]\) and 58 of 128 favorable signs. | `RELEASED` | [`results/symbolic-calibration-v1/summary.json`](../results/symbolic-calibration-v1/summary.json) |
...
| V2 freezes an eight-environment, six-agent, 192-by-8 calibration design with six Holm-family primary comparisons. | `REGISTERED` | [`docs/symbolic-confirmatory-v2.md`](../docs/symbolic-confirmatory-v2.md) |
...
| The local 32-GiB-class workstation passed E192 analysis but failed the v2 E768 host-capacity gate. | `OPERATIONAL` | [`docs/symbolic-v2-operational-preflight.md`](../docs/symbolic-v2-operational-preflight.md) |
...
- calibrated learned-estimator coverage or large-instance identification;
